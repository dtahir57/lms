    ...
    <section id="checkout">
        ...
        <div class="checkout-details">
            <div class="pricing-wrapper">
                ...
                <div class="package-wrapper">
                    <div class="package-values active-price"><h2>Basic <span><img src="assets/img/checkout/arrow-current.png" width="20"></span></h2></div>
                ...
                <div class="package-wrapper">
                    <div class="package-values"><h2>Popular <span><img src="assets/img/checkout/arrow-current.png" width="20"></span></h2></div>
                ...
                <div class="package-wrapper">
                    <div class="package-values"><h2>Premium <span><img src="assets/img/checkout/arrow-current.png" width="20"></span></h2></div>
            ...
            <div class="form-details">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <input type="text" name="" placeholder="Office Address">
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-6">
                        <select>
                            <option class="selectpickeroptions" value="-1">Country</option>
                            <option class="selectpickeroptions" value="-1">Country</option>
                            <option class="selectpickeroptions" value="-1">Country</option>
                        </select>
                    </div>
                ...
                <div class="features-options">
                    <div class="image-wrapper">
                        <img src="assets/img/checkout/assistance.svg">
                    </div>
                ...
                <div class="features-options">
                    <div class="image-wrapper">
                        <img src="assets/img/checkout/money.svg">
                    </div>
                ...
                <div class="features-options">
                    <div class="image-wrapper">
                        <img src="assets/img/checkout/secure.svg">
                    </div>
